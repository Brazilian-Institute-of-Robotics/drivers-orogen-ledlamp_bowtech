...
#ifndef LEDLAMP_BOWTECH_TASK_TASK_HPP
...
namespace ledlamp_bowtech {
     ...
     * The name of a TaskContext is primarily defined via:
     ...
     deployment 'deployment_name'
         task('custom_task_name','ledlamp_bowtech::Task')
     end
     \endverbatim
    ...
    protected:
        ...
        virtual bool setLed_list(std::vector<ledlamp_bowtech::LedLamp > const& ledlist);
    ...
    public:
         ...
         */
        Task(std::string const& name = "ledlamp_bowtech::Task");
